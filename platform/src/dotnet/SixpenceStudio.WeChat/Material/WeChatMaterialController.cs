...
namespace SixpenceStudio.WeChat.Material
{
    ...
    public class WeChatMaterialController : BaseController
    {
        ...
        {
            return new WeChatMaterialService().GetNewsMaterial(pageIndex, pageSize);
        }
        ...
        {
            new WeChatMaterialController().AddNews(title, thumb_media_id, author, digest, show_cover_pic, content, content_source_url, need_open_comment, only_fans_can_comment);
        }
    }
}
